export const postsData = [
  {
    ...
    description: `<strong>Recently,</strong> Google announced it was laying off approximately 6% of its workforce (or 12,000 people). This brings it in line with most of the rest of the tech industry. The reason given by a publicly contrite CEO was that they’d overhired in the boom following the COVID pandemic and that now they had to address it but they were oh-so-sorry and took full responsibility. Like many others my first reaction to this rationale was “bullshit”. I imagine the same is true for the people at Meta, Amazon, Microsoft et al going through this. I spent 10 years at Google so I have some views on how these things come about and they don’t reflect well on the people running the company.
        ...
        This stands at the heart of the current situations being faced by companies like Google today. There are institional investors with the means to take them to court and these investors see Google as a company that is wasteful that they can extract more value from. That’s not to say you have to maximise profits (thanks to those that pointed out my imperfect understanding of US corporate law in the comments and on HN) but it does enable pressure to be put on you. I do not envy the people trying to navigate this. At its heart this is a problem about unrestrained capitalism.
        ...
        In the many years since that original letter the company has changed beyond recognition. As well as the oft quoted “Don’t be evil” mantra the company has grown to nearly 200,000 full time employees and a market cap of over a trillion dollars. Because it has been such a good long term bet, large investors have flocked to own stock in the company and it has served them well over a long period of time. So, why are they becoming restless now?
        Along the way some other big tech companies rose up and a war erupted to hire the best talent. This has led to spiralling compensation packages. Google has also continued growing rapidly (roughly 22,000 people hired to the end of 2022). If you look at the median compensation $300,000 then you could say that those 22,000 people added $6.6 billion in salary overheads alone over the course of 2022. An eye watering sum. Though perhaps not so much if the company is making $16 billion profit EVERY SINGLE quarter despite that. Investors look at this and wonder if they’ve gotten that value back.
        And, to be fair, investors have a point. Google is incredibly wasteful in the way it deploys people. However, by taking the blunt force approach to headcount reduction they’re not addressing the root causes of these and actually harming themselves in the long run. There are no studies which show that downsizing a company this way leads to improvements in productivity. In fact there is lots of evidence that they’ll lose out because people will be more averse to risk and have lower trust in their leadership.
        The way the company has gone about it, too, leaves a bad taste in the mouth. Finding out that you no longer have a job because you can’t log in any more (sometimes in cases where someone is on call for protecting your production systems) is no way to fire anyone. That’s like being in an abusive relationship with some kind of narcissistic sociopath. First off you get showered with praise for having made the cut and lots of fancy perks. Then you get fired by text message and ghosted. Then you’re told to be grateful for the generous severance package. The managers and teams of people fired this way will be devastated. The people fired this way will spend years putting their self esteem back together. The senior leadership all had a part to play in this. They chose the expedient answer — possibly by convincing themselves they were managing risk and taking the Macbeth approach of “If it were done when ’tis done, then ’twere well
        It were done quickly”.
        So, to recap. Google’s leadership have done a stupid thing — mass firing — in stupid way. The problem they’re trying to solve is “how do we get rid of enough people to make investors happier?” and the outcome is “have 6% less people”. Behaving like Elon Musk isn’t the sort of thing any empathetic leadership group should aspire to. To be fair there is no good way to fire 12,000 people but there are ways which are more humane than others. All of which is a distraction from the fundamental question — why is Google so wasteful?
        The answer this question lies in personal ambition. At the senior echelons of the company there aren’t enough VP jobs to go around for a group of highly motivated, ambitious and (increasingly) ruthless people. I’ve loitered around the edges of this world and a large part of my value was to insulate my teams from ever having to experience it. It’s like Game of Thrones played out through email and calendar and over video call.
        In order to get promoted to senior levels (starting from director up) your organisation needs to look a certain way. There are boxes you have to tick including having the right people at the right levels underneath you. The long term approach to this would be to grow your people and that this will naturally happen if you’re working on things that matter. The trouble is that this takes time and you’re never more than 6–18 months away from a potential reorg that might make you start again from scratch. Ambitious people also tend to be impatient. So, what do you do?
        ...
        The people being affected by the layoffs are not the people who’ve made and benefited from those decisions. The people who will benefit from the stock price bump. The people who will post on LinkedIn how it is about misjudging the market and how they’re so sorry and take full responsibility. The people in the dark rooms deciding who will go and who will stay while their personal wealth accumulates. The investors who just want another billion in the bank account. If Google wanted to make a meaningful change then addressing the bloated layers of senior management would be the place to start but — as they say — turkeys don’t vote for Christmas. It should look at why it is wasteful and take the hard decisions to address it. A 6% reduction is a blunt tool which is basically an admission that you aren’t running your company as a business properly. If that’s the case — why aren’t the people running the business the ones shortly to be entering the job market?
        At the end of this, the root causes of Google’s wastefulness won’t have been addressed. The execs may never recover the trust they’ve lost by the way they’ve approached this. Creativity will have been stifled. Business performance won’t improve. Google will have drifted further from its founding vision to the loss of us all. Large investors now know they can flex their muscles and Google’s CEO will cave in. The rich will get richer and will learn to rationalise the 12,000 people they left by the wayside. The cycle will start again.
        It doesn’t have to be this way. In 2013, Nintendo’s boss said he would not fire anyone to please shareholders. In 2017 they launched the Switch. Over that period Nintendo’s stock has increased by a factor of nearly five which is 19% a year (including the drop most of the stock market experienced last year). Google has missed a golden opportunity to make better use of 12,000 highly talented human beings. All in the name of keeping some rich people happy.
        Epilogue: everything I’ve written about above I have seen personally play out many times during the time I spent at Google. I’ve also seen incredible people rewarded for doing the right thing. My experience is that gets rarer the higher you get in the hierarchy.`,
  },
  {
    id: 2,
